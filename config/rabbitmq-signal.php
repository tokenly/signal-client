...
return [
    ...
    'vhost' => env('RABBITMQ_SIGNAL_VHOST', env('RABBITMQ_VHOST', '/')),
    'login' => env('RABBITMQ_SIGNAL_LOGIN', env('RABBITMQ_LOGIN', 'guest')),
    'password' => env('RABBITMQ_SIGNAL_PASSWORD', env('RABBITMQ_PASSWORD', 'guest')),
